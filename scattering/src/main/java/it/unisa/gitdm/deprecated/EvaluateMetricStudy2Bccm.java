...
class EvaluateMetricStudy2Bccm {

    public static void main(String args[]) {
        File baseFolder = new File("/media/Dati/scattering/");
        ...
        for (File file : roots) {
            File firstExperimentFolder = new File(file.getAbsolutePath() + "/3m/periodsData_2_bccm/");
            ...
            for (int i = 0; i < firstExperimentFolder.listFiles().length; i++) {
                ...
                Utility.writeFile(csvToPrint, file.getAbsolutePath() + "/3m/results_periodsData_2_bccm.csv");
            }
        }
    }
