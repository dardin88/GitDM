...
class EvaluateMetricStudy1Workload {
    ...
    public static void main(String args[]) {
        ...
        for (File file : roots) {
            File firstExperimentFolder = new File(file.getAbsolutePath() + "/3m/periodsData_1_workload/");
            ...
            for (int i = 0; i < firstExperimentFolder.listFiles().length; i++) {
                ...
                Utility.writeFile(csvToPrint, file.getAbsolutePath() + "/3m/results_periodsData_1_workload.csv");
            }
        }
    }
