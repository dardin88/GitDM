...
class EvaluateMetricStudy1NOC {

    public static void main(String args[]) {
        File baseFolder = new File("/Users/fabiopalomba/Documents/PhD/Papers/Working/Bug Prediction/results/");
        ...
        for (File file : roots) {
            File firstExperimentFolder = new File(file.getAbsolutePath() + "/3m/periodsData_1_numOfChanges/");
            ...
            for (int i = 0; i < firstExperimentFolder.listFiles().length; i++) {
                ...
                if ((i + 1) != firstExperimentFolder.listFiles().length) {
                    ...
                    try {
                        ...
                        filteredClassifier.setClassifier(new DecisionTable());
                ...
                Utility.writeFile(csvToPrint, file.getAbsolutePath() + "/3m/results_periodsData_1_numOfChanges.csv");
            }
        }
    }
